                    ...
                    <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="update-form">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="3" required 
                                      class="form-control" placeholder="Enter task description">{{ $task->description }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select">
                                ...
                                <option value="completed" {{ $task->status == 'non pending' ? 'selected' : '' }}>Non Pending</option>
                            </select>
                        </div>
